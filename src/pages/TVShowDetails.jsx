...
if (loading) {
return ( <main className="tv-details-page"> <div className="tv-details-loader"> <div className="tv-loader-spinner"></div>


      <h5>Loading Series...</h5>

      <p>
        Preparing show details and episodes
      </p>
    </div>
  </main>
);
...
if (!show) {
return ( <main className="tv-details-page"> <div className="tv-error-state"> <div className="tv-error-icon">📺</div>
...
return ( <main className="tv-details-page">
      ...
      {isPlaying ? (
        <div className="player-wrapper">
          ...
          <div className="player-language-note">
            ...
            <span>
              Language availability depends on the
              streaming server.
            </span>
          </div>
        ...
        <div className="player-placeholder">
          ...
          <p>
            Select an episode below and start streaming.
          </p>
    ...
    <section className="episodes-section">
      ...
      {loadingEpisodes ? (
              ...
              >
                ...
                <div className="episode-thumbnail">
                  ...
                  {episode.still_path ? (
                    ...
                    <div className="episode-no-image">
                      🎬
                    </div>
                  )}
        ...
        <div className="empty-episodes">
          ...
          <p>
            Episodes are not available for this season.
          </p>
